...
public sealed class ServerService
{
    ...
    public SocketCategoryChannel GetCategory(Func<SocketCategoryChannel, bool> predicated, ulong guildID) => Client.GetGuild(guildID).CategoryChannels.First(predicated);
